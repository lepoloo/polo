...
async def detail_reel(reel_id: str, db: Session = Depends(get_db)):
    ...
    details = [{ 'id': like.id, 'refnumber': like.refnumber, 'owner_id': like.owner_id, 'event_id': like.event_id, 'anounce_id': like.anounce_id, 'reel_id': like.reel_id, 'active': like.active} for like in likes]
    likes = details
