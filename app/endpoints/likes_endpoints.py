...
async def detail_like_by_attribute(refnumber: Optional[str] = None, event_id: Optional[str] = None, owner_id: Optional[str] = None, anounce_id: Optional[str] = None, skip: int = 0, limit: int = 100, db: Session = Depends(get_db)):
